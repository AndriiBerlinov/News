...
@Composable
fun SearchScreen(newsApiClient: NewsApiClient, navController: NavHostController, searchText: String) {
            ...
            newsApiClient.getEverything(
                ...
                object : NewsApiClient.ArticlesResponseCallback {
                    ...
                    override fun onFailure(throwable: Throwable) {
                        // Handle error
                        Log.e("NewsApiClient", "Failed to fetch everything", throwable)
                    }
                }
            )
        }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Text(
                text = "Search result for the query: $searchText",
